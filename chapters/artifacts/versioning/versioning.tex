...
\todo[inline]{Nur Software, die wirklich auf das ausweisen der backward comp
angewiesen ist, sollte ein solch manuelles Schema wählen! Beziehen auf die
Consumer und Producer.}

\todo[inline]{Add subsection sub headlines.}

\todo[inline]{Add implementation using Azure DevOps.}
