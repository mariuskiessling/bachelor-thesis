...
\fbox{%
  \parbox{0.935\textwidth}{
    ...
    \begin{tabbing}
      ...
      \textbf{Studiengang, Kurs:} \> Angewandte Informatik, \kurs\\
    ...
    Ich versichere hiermit, dass ich meine Bachelorarbeit mit dem Thema \textit{\titel} selbstständig verfasst und keine anderen als die angegebenen Quellen und Hilfsmittel benutzt habe.
    \linebreak\linebreak
    ...
    \begin{minipage}[b]{0.35\linewidth}
      \begin{tikzpicture}[line width=0.75pt,every node/.style={inner sep=0,outer sep=0}] 
        \node[anchor=west] (field value) at (0,0.9) {Ratingen, 31.08.2019};
        \draw[-] (0,0.5) -- (6,0.5);
