...
An artefact cannot only be an instantiation, e.g.\ a software prototype, but
...
inside the environment. All designed artefacts have to be tested inside the
...
In this thesis, at least one artefact will be developed for each
\href{link:problem_domains}{problem domain}. These artefacts answer the
research question of their respective problem domain. 
