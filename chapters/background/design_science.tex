...
In general, the goal behind \ac{DSR} is to design \ac{IT} \textit{artifacts}.
An artifact can not only be an instantiation, e.g.\ a software prototype, but
