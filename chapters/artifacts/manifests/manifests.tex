...
latest\textquotedbl} and replaces it with
\texttt{version:\textquotedbl\textbf{build-number}\textquotedbl}. The result is
then written in the service's \texttt{values.yaml} file.
