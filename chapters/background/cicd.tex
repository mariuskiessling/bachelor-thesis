...
to tests. Before compiling, a separate stage hold all test utilities needed to
test the software. The tests are executed a second time and process only
proceeds if all tests pass a second time inside that specialised early build
stage.
