...
\begin{figure}[H]
\begin{center}
  \missingfigure{Add figure showing the differences of monolithic and microservice application.}
...
also be discussed in chapter \todo{Add correct chapter reference.} TODO.
